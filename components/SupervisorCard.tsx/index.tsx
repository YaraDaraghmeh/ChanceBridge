...
const SupervisorCard = ({id,profileImage,rate}:Isupervisor) => {
  return (
    <div  key={id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
